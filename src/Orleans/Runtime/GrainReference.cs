...
namespace Orleans.Runtime
{
    ...
    public class GrainReference : IAddressable, IEquatable<GrainReference>, ISerializable
    {
        ...
        /// Called from generated code.
        /// </summary>
        protected async Task<T> InvokeMethodAsync<T>(int methodId, object[] arguments, TypeInfo[] genericTypeParameters = null, InvokeMethodOptions options = InvokeMethodOptions.None, SiloAddress silo = null)
        {
